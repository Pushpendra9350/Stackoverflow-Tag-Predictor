...
model = joblib.load("final_stackoverflow_logistic_regression.pkl")
vectorizer = joblib.load("final_stackoverflow_tfidf_vectorizer.pkl")
tags = pd.read_csv("tag_list_500.csv")
